...
const buttonRegister = document.getElementById('button-register-cotizacion');
buttonRegister.addEventListener('click', function(e){
    e.preventDefault();

    if(ProductosCarrito != null && clienteValido != null){
        let Cotizaciones = JSON.parse(localStorage.getItem('Cotizaciones'))
        let NuevoId = String(Math.max(...Cotizaciones.map(producto => parseInt(producto.Id)))+1);
        let newCotizaciones = {
            Id: NuevoId,
        ...
        Cotizaciones.push(newCotizaciones);
